...
import stylesCss from 'themes/hypnobook/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_hypnobook_componentCss']) {
    
    document['_vaadintheme_hypnobook_componentCss'] = true;
  }
